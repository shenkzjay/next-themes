...
export const NavOverlay = () => {
  return (
    <nav
      className="flex md:justify-between md:flex-row flex-col relative md:mx-auto md:container mx-6"
      role="navigation"
    ...
    >
      ...
      <ul
        id="menu"
        aria-label="main-menu"
        className="flex flex-col md:flex-row md:space-x-6 [transform:_translateX(-200%);] md:[transform:_none] target:[transform:_translateX(0%);] w-full md:w-auto bg-[purple] md:bg-transparent fixed md:relative top-0 left-0 h-full z-50 [transition:_transform_.3s_ease-out] px-6 py-16 md:p-2 gap-6"
      >
        <li
          tabIndex={0}
          role="link"
